    ...
    <div class="col s12 m6">
      <div class="card blue-grey darken-1">
        <div class="card-content white-text">
          <span class="card-title">Bodhi Yoga Teacher Certification</span>
          ...
          • Skills for designing individually appropriate private sessions with confidence & authenticity.</p>
        </div>
        <div class="card-action">
          <a href="https://www.gobodhiyoga.com/certification-utahyogateachertraining/">This is a link</a>
        </div>
      </div>
    </div>
    <div class="col s12 m6">
      <div class="card blue-grey darken-1">
        ...
        <div class="card-action">
          <a href="https://www.gobodhiyoga.com/utah-yoga-partner-training/">This is a link</a>
        </div>
      </div>
    </div>
    <div class="col s12 m6">
      <div class="card blue-grey darken-1">
        <div class="card-content white-text">
          <span class="card-title">Other Crdentials </span>
          <p> Credentials:
                Bachelors Degree; Exercise & Sports Science 
                American College of Sports Medicine ;Exercise Physiologist
                200hr Bodhi Yoga Teacher Certified, 
                200hr Restorative Partner Yoga Certification, 
                YogaFit Teacher Training Level 1
                TRX Certified</p>
        </div>
        <div class="card-action">
          <a href="https://www.gobodhiyoga.com/utah-yoga-partner-training/">This is a link</a>
